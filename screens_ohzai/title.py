...
def title(color_mode):
    ...
    logo = pygame.image.load("screens_ohzai/assets/kroz_logo.png").convert_alpha()
    ...
    # Load custom fonts
    font_white = pygame.font.Font("screens_ohzai/assets/PressStart2P.ttf", 12)
    font_yellow = pygame.font.Font("screens_ohzai/assets/PressStart2P.ttf", 10)
    font_cyan = pygame.font.Font("screens_ohzai/assets/PressStart2P.ttf", 10)
